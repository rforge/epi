...
###################################################
### code chunk number 1: flup.rnw:155-161
###################################################
options( width=90,
...
###################################################
### code chunk number 2: flup.rnw:238-240
###################################################
library(Epi)
...
###################################################
### code chunk number 3: flup.rnw:246-253
###################################################
data( nickel )
...
###################################################
### code chunk number 4: flup.rnw:263-266
###################################################
str( nickel )
str( nicL )
head( nicL )
...
###################################################
### code chunk number 5: flup.rnw:275-276
###################################################
summary( nicL )
...
###################################################
### code chunk number 8: flup.rnw:330-333
###################################################
...
###################################################
### code chunk number 9: flup.rnw:341-342
###################################################
round( subset( nicS1, id %in% 8:10 ), 2 )


###################################################
### code chunk number 10: flup.rnw:348-350
###################################################
...
###################################################
### code chunk number 11: flup.rnw:355-360
###################################################
library( popEpi )
...
###################################################
### code chunk number 12: flup.rnw:364-367
###################################################
...
###################################################
### code chunk number 13: flup.rnw:387-395
###################################################
...
###################################################
### code chunk number 14: flup.rnw:415-416
###################################################
summary( (nicS2$age-nicS2$tfh) - nicS2$age1st ) 


###################################################
### code chunk number 15: flup.rnw:421-423
###################################################
...
###################################################
### code chunk number 16: flup.rnw:445-453
###################################################
...
###################################################
### code chunk number 17: flup.rnw:460-468
###################################################
...
###################################################
### code chunk number 18: flup.rnw:527-529
###################################################
...
###################################################
### code chunk number 19: flup.rnw:542-547
###################################################
...
###################################################
### code chunk number 21: flup.rnw:582-584
###################################################
...
###################################################
### code chunk number 22: flup.rnw:594-595
###################################################
summary( nickel$age1st )


###################################################
### code chunk number 23: flup.rnw:599-605
###################################################
...
###################################################
### code chunk number 25: flup.rnw:629-630
###################################################
anova( ma, mat, test="Chisq" )


###################################################
### code chunk number 26: flup.rnw:641-645
###################################################
...
###################################################
### code chunk number 28: flup.rnw:673-684
###################################################
...
###################################################
### code chunk number 29: flup.rnw:699-708
###################################################
data( nickel )
nicL <- Lexis( entry = list( per = agein+dob,
                             age = agein,
...
###################################################
### code chunk number 30: flup.rnw:713-722
###################################################
nicL <- Lexis( entry = list( per = agein+dob,
                             age = agein,
                             tfh = agein-age1st ),
...
###################################################
### code chunk number 31: flup.rnw:734-742
###################################################
...
###################################################
### code chunk number 32: flup.rnw:761-770
###################################################
nicC <- cutLexis( data = nicL,
                   cut = nicL$agehi,
             timescale = "age",
