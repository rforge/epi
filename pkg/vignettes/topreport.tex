...
%----------------------------------------------------------------------
% Specifics for course material
% Should figures be included?
% \newcommand{\figin}[1]{}  % NO
\newcommand{\figin}[1]{#1}  % YES
% Should solution text be included?
% \newcommand{\soltxt}[1]{}  % NO
\newcommand{\soltxt}[1]{#1}  % YES
