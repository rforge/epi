...
since its first appearance in the \emph{Epi} package in 2008 it has
been expanded with a number of utilities, as can be seen from the last
chapter of this note: ``\texttt{Lexis} functions''.
